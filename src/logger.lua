-- Logger module for Lua
-- Author: ugolnikovE
-- Repository: https://github.com/ugolnikovE/langstat
-- Description: Provides a simple logging system with support for log levels
--              (DEBUG, INFO, WARN, ERROR), optional file output, and console logging.
